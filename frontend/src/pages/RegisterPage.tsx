...
import { FileStack, Loader2, Check, X } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-ink-50 dark:bg-ink-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-2xl p-7 shadow-sm">
          <h1 className="font-display text-2xl font-semibold mb-1 text-ink-900 dark:text-ink-50">Create your account</h1>
          <p className="text-sm text-ink-400 mb-6">Upload your knowledge. Ask questions. Get grounded answers.</p>
              ...
              {password.length > 0 && (
                <ul className="mt-2 space-y-1">
                  {rules.map((r) => {
                    ...
                    return (
                      <li key={r.label} className={`text-xs flex items-center gap-1.5 ${ok ? "text-teal-600 dark:text-teal-400" : "text-ink-400"}`}>
